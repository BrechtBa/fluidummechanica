...
Uit deze vergelijking kan nog een interessante bemerking afgeleid worden. Indien we een nieuwe grootheid definieren die bestaat uit de som van de druk in de druk in de vloeistof en de hydrostatische druk die zou veroorzaakt worden in een stilstaande vloeistof. In de $x$-richting wordt dit:
\begin{equation}
	p_{g,x} = p - \rho g_x x
\end{equation}
...
Dit leid tot de conclusie dat de zwaartekracht enkel een drukverandering veroorzaakt die overeenstempt met de drukverandering wanneer het fluïdum stilstaat. Dit resultaat kunnen we in volgende hoofdstukken gebruiken.
