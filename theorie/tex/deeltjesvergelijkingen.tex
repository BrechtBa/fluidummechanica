...
Uit deze vergelijking kan nog een interessante bemerking afgeleid worden. We kunnen een nieuwe grootheid definiëren die bestaat uit de som van de druk in het fluïdum en de hydrostatische druk die zou veroorzaakt worden door de zwaartekracht in een stilstaand fluïdum. In de $x$-richting wordt dit:
\begin{equation}
	p_{g,x} = p - \rho g_x x
\end{equation}

De partieel afgeleide hiervan naar $x$ komt net overeen met de drukterm en de zwaartekrachtsterm in de Navier-Stokes vergelijking. Deze kan dus herschreven worden als:
\begin{equation}
	\rho \left(\frac{\partial v_x}{\partial t} + v_x \frac{\partial v_x}{\partial x} + v_y \frac{\partial v_x}{\partial y} + v_z \frac{\partial v_x}{\partial z} \right) = -\frac{\partial p_{g,x}}{\partial x} + \mu \left( \frac{\partial^2 v_x}{\partial x^2} + \frac{\partial^2 v_x}{\partial y^2} + \frac{\partial^2 v_x}{\partial z^2} \right)
\end{equation}

Dit leidt tot de conclusie dat de zwaartekracht enkel een drukverandering veroorzaakt die overeenstemt met de drukverandering wanneer het fluïdum stilstaat. Dit resultaat kunnen we in volgende hoofdstukken gebruiken.
