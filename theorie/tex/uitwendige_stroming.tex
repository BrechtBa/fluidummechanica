...
\begin{voorbeeld}
	...
	\begin{center}
		\includegraphics{fig/uitwendige_stroming/Potentiaalstroming_cilinder}
	\end{center}
	...
	\begin{center}
		\includegraphics{fig/uitwendige_stroming/Potentiaalstroming_doublet}
	\end{center}
	...
	\begin{center}
		\includegraphics{fig/uitwendige_stroming/Potentiaalstroming_cilinder_stroomlijnen}
	\end{center}
	
\end{voorbeeld}

Geïnteresseerde lezers worden verwezen naar \cite{Currie2003} waar een groot aantal 2D en 3D potentiaalstromingen besproken en geanalyseerd worden.
...
\begin{figure}[htb]
	\centering
	\includegraphics{fig/uitwendige_stroming/cilinderstroming_Cd.pdf}
...
\begin{figure}[htb]
	...
	\subfigure[Re = 1]{
		...
		\includegraphics[height=0.2\textwidth]{fig/uitwendige_stroming/Stroomfunctie_Re1_bw.png}
	} \quad
	\subfigure[Re = 10]{
		\label{fig:cilinder Re 10}
		\includegraphics[height=0.2\textwidth]{fig/uitwendige_stroming/Stroomfunctie_Re10_bw.png}
	}
	\\
	\subfigure[Re = 100]{
		\label{fig:cilinder Re 100}
		\includegraphics[height=0.2\textwidth]{fig/uitwendige_stroming/Stroomfunctie_Re100_bw.png} 
	} \quad
	\subfigure[Re = 1000]{
		\label{fig:cilinder Re 1000}
		\includegraphics[height=0.2\textwidth]{fig/uitwendige_stroming/Stroomfunctie_Re1000_bw.png}
	}
	\\
	\subfigure[Re = 100000]{
		\label{fig:cilinder Re 100000}
		\includegraphics[height=0.2\textwidth]{fig/uitwendige_stroming/Stroomfunctie_Re10000_bw.png}
	}
...
\begin{figure}[htb]
	\centering
	\includegraphics{fig/uitwendige_stroming/NACA_4412_Cl.pdf}
	\includegraphics{fig/uitwendige_stroming/NACA_4412_Cd.pdf}
...
\end{align}
Deze effecten komen echter pas tot uiting bij verandering van het Reynoldsgetal over meerdere grootte ordes en hoeven bij veel toepassingen niet in rekening worden gebracht.
