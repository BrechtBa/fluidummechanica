...
F = np.array([1.0,1.5,1.5,4.6,4.3,2.7,9.0,3.2,0.2,1.8,3.1,4.0,8.1,11.8,11.0,19.1,19.8,14.3,2.1,3.7,5.7,10.5,17.6,22.2,23.8,41.5,34.7])*1000   # N
no = range(1,len(N)+1)

# create a latex table
textablepy.textable( [no,N,D,v,F/1000],f=['{:}','{:.0f}','{:.2f}','{:.1f}','{:.1f}'] )


# plotting the raw data
plt.figure(figsize=(16/2.54,12/2.54))
p = plt.scatter(N,F/1000,c=v, s=D*500, alpha=0.7,cmap=plt.cm.viridis)
cbar = plt.colorbar(p)
