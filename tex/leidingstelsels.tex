...
\begin{equation}
	z_1 + \frac{p_1}{\rho g} + \frac{v_1^2}{2 g} - h_\mathrm{L} =  z_2 + \frac{p_2}{\rho g} + \frac{v_2^2}{2 g} \nonumber
\end{equation}

In beide punten is de snelheid bij benadering gelijk aan nul, en de druk atmosfeerdruk. Bovenstaande vergelijking vereenvoudigt zich dus tot:
\begin{equation}
	z_1 - z_2 = h_\mathrm{L}
