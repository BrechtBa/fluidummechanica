...
\end{equation}
Waarin $E$ de totale energieinhoud van het systeem voorstelt, en $\dot{Q}$ en $\dot{W}$ respectievelijk de warmtestroom naar het systeem en het arbeidsvermogen uit het systeem voorstellen (stromen van een bepaalde grootheid zullen in deze cursus met een punt aangeduid worden).
...
Voor het gebruik in de fluïdomechanica zijn deze formuleringen echter niet zo geschikt. Een massa fluïdum zal namelijk steeds van vorm veranderen en kan zelfs opgesplitst worden in verschillende delen. Het uitwerken van de behoudswetten zal in de meeste gevallen niet eenvoudig zijn.
...
Wanneer we de vergelijking van behoud van massa voor een controlevolume en een controle massa vergelijken zien we dat enkel het linkerlid van vorm verandert. We kunnen dezelfde transformatie ook toepassen op de vergelijking van behoud van impuls. Dit wordt:
\begin{equation}
...
\end{equation}
Het stromingsvermogen kunnen we uitwerken als de uitgeoefende kracht vermenigvuldigd met de snelheid van de stroming aan de in en uitgangen. Met inachtname van de tekenconventie wordt dit:
\begin{equation}
