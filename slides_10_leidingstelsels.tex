  	...
  	\begin{frame}
		...
		\only<1>{
  		...
  		\begin{textblock}{6}(5.5,3)
  			\only<3-5>{
  				\begin{equation*}
  					h_{\mathrm{L},1\rightarrow 2} = \left( \frac{1}{\sqrt{R_{\mathrm{h},1}}} + \frac{1}{\sqrt{2R_{\mathrm{v},1}+R_{\mathrm{h},1}}} \right)^{-2} \dot{V}_{\mathrm{v},2}^2
  				\end{equation*}
  				\begin{equation*}
  			...
  			\only<4-5>{
  				\begin{equation*}
  					R_{1\rightarrow 3} = \left( \frac{1}{\sqrt{R_{\mathrm{h},2}}} + \frac{1}{\sqrt{2R_{\mathrm{v},2} + R_{1\rightarrow 2}}} \right)^{-2}
  				\end{equation*}
  			}
  			\only<5-5>{
  				\begin{align*}
  					R_{1\rightarrow n} &= \left( \frac{1}{\sqrt{R_{\mathrm{h},n-1}}} + \frac{1}{\sqrt{2R_{\mathrm{v},n-1}+R_{1\rightarrow n-1}}} \right)^{-2} \\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\section{Pompen en ventilatoren}
  	\begin{frame}
  		...
  		\only<1-4>{
  			\center
  			\textbf{Een pomp of ventilator voert mechanische energie toe aan de stroming}
  		}
  		\only<2-4>{
  			\begin{equation*}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
  	\begin{frame}
  		\frametitle{Leidingskarakteristiek}
  		\only<1-2>{
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
  	\begin{frame}
  		...
  		\only<2-3>{
  			\center
  			\textbf{Het werkingspunt is het snijpunt van de pomp- en leidingskaraketeristiek}
  			
  			\begin{equation*}
  				h_\mathrm{L}(\dot{V}) + \left( \frac{p_2}{\rho g} + 8 \frac{\dot{V}^2}{g \pi^2 D_2^4} + z_2 \right) - \left( \frac{p_1}{\rho g} + 8 \frac{\dot{V}^2}{g \pi^2 D_1^4} + z_1 \right) = h_\mathrm{P}
  			\end{equation*}
  		}
  		\only<3-3>{
  			\begin{equation*}
  				\frac{p_2}{\rho g} + 8 \frac{\dot{V}^2}{g \pi^2 D_2^4} + z_2  = \frac{p_1}{\rho g} + 8 \frac{\dot{V}^2}{g \pi^2 D_1^4} + z_1 - h_\mathrm{L}(\dot{V}) + h_\mathrm{P}
  			\end{equation*}
  		}
    \end{frame} 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
